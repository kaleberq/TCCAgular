...
@Component({
  selector: 'app-pedidos-aprovados-cliente',
  templateUrl: './pedidos-aprovados-cliente.component.html',
  styleUrls: ['./pedidos-aprovados-cliente.component.scss']
})
export class PedidosAprovadosClienteComponent implements OnInit {
